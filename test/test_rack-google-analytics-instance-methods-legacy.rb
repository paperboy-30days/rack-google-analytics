...
class TestRackGoogleAnalyticsInstanceMethodsLegacy < Test::Unit::TestCase

  include Rack::Test::Methods

  class MockController < ActionController::Base
    def index
      set_ga_custom_var(1, "Items Removed", "Yes", GoogleAnalytics::Legacy::CustomVar::SESSION_LEVEL)
